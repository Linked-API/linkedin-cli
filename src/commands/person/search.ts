...
export default class PersonSearch extends BaseCommand {
  static override description = 'Search for people on LinkedIn';
  ...
  public async run(): Promise<void> {
    const { flags } = await this.parse(PersonSearch);
